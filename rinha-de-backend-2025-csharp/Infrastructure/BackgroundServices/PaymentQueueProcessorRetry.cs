...
{
    public class PaymentQueueProcessorRetry : BackgroundService
    {
        private readonly ConnectionMultiplexer _connectionMultiplexer;
        private readonly IServiceProvider _serviceProvider;
        public PaymentQueueProcessorRetry(ConnectionMultiplexer connectionMultiplexer, IServiceProvider serviceProvider)
        {
        ...
        private async Task ProcessPaymentItemAsync(CancellationToken cancellationToken)
        {
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                var item = await redis.ListLeftPopAsync("payments-queue-retry");
